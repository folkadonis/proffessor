      ...
      <div className="auth-container-professional">
        <div className="auth-card">
          <div className="auth-header">
            ...
            <p className="auth-subtitle">Sign up to start testing your knowledge</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="auth-form-professional">
            ...
            <button type="submit" className="btn btn-primary btn-lg w-full" disabled={loading || !agreedToTerms}>
              {loading ? (
                <>
